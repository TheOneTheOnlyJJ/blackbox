...
import {
  LOCAL_SQLITE_USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA,
...
import { OPTION_B_USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA, IOptionBUserDataStorageConfigInputData } from "./implementations/optionB";
import { OPTION_C_USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA, IOptionCUserDataStorageConfigInputData } from "./implementations/optionC";
...
export const USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA_MAP: UserDataStorageConfigInputDataJSONSchemaMap = {
  [USER_DATA_STORAGE_TYPES.LocalSQLite]: LOCAL_SQLITE_USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA,
  [USER_DATA_STORAGE_TYPES.OptionB]: OPTION_B_USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA,
  [USER_DATA_STORAGE_TYPES.OptionC]: OPTION_C_USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA
} as const;
...
export const USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA: JSONSchemaType<UserDataStorageConfigInputData> = {
  ...
  anyOf: Object.keys(USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA_MAP)
    .sort()
    .reduce<JSONSchemaType<UserDataStorageConfigInputData>[]>(
      (accumulator: JSONSchemaType<UserDataStorageConfigInputData>[], currentValue: string) => {
        accumulator.push(
          USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA_MAP[currentValue as keyof typeof USER_DATA_STORAGE_CONFIG_INPUT_DATA_JSON_SCHEMA_MAP]
        );
        return accumulator;
      },
      []
