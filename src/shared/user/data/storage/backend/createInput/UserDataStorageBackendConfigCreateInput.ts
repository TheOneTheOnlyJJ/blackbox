...
} from "./implementations/LocalSQLiteUserDataStorageBackendConfigCreateInput";
...
} from "./implementations/optionB";
import {
  OPTION_C_USER_DATA_STORAGE_BACKEND_CONFIG_CREATE_INPUT_JSON_SCHEMA,
  IOptionCUserDataStorageBackendConfigCreateInput
} from "./implementations/optionC";

// Map of every user data storage backend type to its corresponding config input type
