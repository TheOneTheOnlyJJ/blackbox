...
export const injectDefaultsInObjectJSONSchema = <T>(schema: JSONSchemaType<T>, defaults: Partial<T>): JSONSchemaType<T> => {
  ...
  if (SCHEMA_PROPERTIES !== null && SCHEMA_PROPERTIES !== undefined && typeof SCHEMA_PROPERTIES === "object") {
