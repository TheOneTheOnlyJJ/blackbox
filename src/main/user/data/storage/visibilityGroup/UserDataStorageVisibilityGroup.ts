...
export const USER_DATA_STORAGE_VISIBILITY_GROUP_CONSTANTS = {
  AESKeySalt: {
    lengthBytes: 32
  }
} as const;

export const USER_DATA_STORAGE_VISIBILITY_GROUP_JSON_SCHEMA: JSONSchemaType<IUserDataStorageVisibilityGroup> = {
