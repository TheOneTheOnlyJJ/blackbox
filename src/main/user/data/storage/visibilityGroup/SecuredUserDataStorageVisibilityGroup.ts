...
export interface ISecuredUserDataStorageVisibilityGroup {
...
export const SECURED_USER_DATA_STORAGE_VISIBILITY_GROUP_JSON_SCHEMA: JSONSchemaType<ISecuredUserDataStorageVisibilityGroup> = {
