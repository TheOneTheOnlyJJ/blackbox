...
export interface IUserDataTemplateTextFieldConfig extends IBaseUserDataTemplateFieldConfig {
  type: UserDataTemplateFieldTypes["text"];
  useTextBox: boolean;
  default: string | null;
}

export const USER_DATA_TEMPLATE_TEXT_FIELD_CONFIG_JSON_SCHEMA: JSONSchemaType<IUserDataTemplateTextFieldConfig> = {
  ...
  required: [...BASE_USER_DATA_TEMPLATE_FIELD_CONFIG_JSON_SCHEMA_REQUIRED_ARRAY, "useTextBox", "default"],
  additionalProperties: false
} as const;

export const isValidUserDataTemplateTextFieldConfig: ValidateFunction<IUserDataTemplateTextFieldConfig> = AJV.compile(
